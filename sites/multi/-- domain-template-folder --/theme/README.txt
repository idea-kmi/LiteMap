...
IMPORTANT NOTE: Always leave the 'default' theme alone. Never edit or delete it.
It is the fallback location for all style sheets, interface images, etc..
so the LiteMap will not work correctly without it.

CREATING A NEW THEME

To create a new theme:
1. Create a folder with your new theme name inside the main '/theme' folder.
