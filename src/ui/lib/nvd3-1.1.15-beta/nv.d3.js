    ...
    selection.each(function(data) {
      ...
      if (onlyCircles) {
        ...
        points.enter().append('circle')
            ...
            .attr('r', function(d,i) { if (d.radius) {return d.radius; } else {Math.sqrt(z(getSize(d,i))/Math.PI)} });
        points.exit().remove();
        ...
        points.transition()
            .attr('cx', function(d,i) { return nv.utils.NaNtoZero(x(getX(d,i))) })
            .attr('cy', function(d,i) { return nv.utils.NaNtoZero(y(getY(d,i))) })
            .attr('r', function(d,i) { if (d.radius) {return d.radius; } else {return Math.sqrt(z(getSize(d,i))/Math.PI)} });
