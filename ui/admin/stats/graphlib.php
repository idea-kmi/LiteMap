...
function init_colours() {
  ...
  $claim = $this->hex2rgb($CFG->claimback);
  ...
  $argument = $this->hex2rgb($CFG->argumentback);
  $people = $this->hex2rgb($CFG->peopleback);
  $map = $this->hex2rgb($CFG->mapback);
  $idea = $this->hex2rgb($CFG->ideaback);
  $comment = $this->hex2rgb($CFG->commentback);
  ...
  $this->colour['claim'] = ImageColorAllocate ($this->image, $claim[0], $claim[1], $claim[2]);
  ...
  $this->colour['argument'] = ImageColorAllocate ($this->image, $argument[0], $argument[1], $argument[2]);
  $this->colour['people'] = ImageColorAllocate ($this->image, $people[0], $people[1], $people[2]);
  $this->colour['map'] = ImageColorAllocate ($this->image, $map[0], $map[1], $map[2]);
  $this->colour['idea'] = ImageColorAllocate ($this->image, $idea[0], $idea[1], $idea[2]);
  $this->colour['comment'] = ImageColorAllocate ($this->image, $comment[0], $comment[1], $comment[2]);
